...
class TestGameSettings(unittest.TestCase):
    ...
    def test_standard_init(self):
        game_settings1 = GameSettings(2, "auto", "balanced_blitz", "static", True, False, False)
    ...
    def test_erroneous_placement_type(self):
        with self.assertRaises(TypeError):
            game_settings1 = GameSettings(2, 4, "balanced_blitz", "static", True, False, False)


    def test_erroneous_dice_rolls_type(self):
        with self.assertRaises(TypeError):
            game_settings1 = GameSettings(2, "auto", 4, "static", True, False, False)


    def test_erroneous_card_bonus_multiplier_type(self):
        with self.assertRaises(TypeError):
            game_settings1 = GameSettings(2, "auto", "balanced_blitz", 5, True, False, False)
    ...
    def test_erroneous_num_players_value(self):
        with self.assertRaises(ValueError):
            game_settings1 = GameSettings(0, "auto", "balanced_blitz", "static", True, False, False)


    def test_erroneous_placement_value(self):
        with self.assertRaises(ValueError):
            game_settings1 = GameSettings(2, "random", "balanced_blitz", "static", True, False, False)


    def test_erroneous_dice_rolls_value(self):
        with self.assertRaises(ValueError):
            game_settings1 = GameSettings(2, "auto", "random", "static", True, False, False)

    
    def test_erroneous_card_bonus_multiplier_value(self):
        with self.assertRaises(ValueError):
            game_settings1 = GameSettings(2, "auto", "balanced_blitz", "dynamic", True, False, False)
